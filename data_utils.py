...
def cleanup_data(df):
    ...
    # Drop columns
    cols_to_drop = ['number', 'driverId', 'raceId', 'constructorId']
    ...
    # Handle missing values - recommended approach to avoid chained assignment
    df.loc[:, 'start_position'] = df['start_position'].fillna(value=10)
    
    # Replace '\N' with NaN - using correct np.nan
